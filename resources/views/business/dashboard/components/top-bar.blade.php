<div class="top-bar-box">
            <div class="container">
                <div class="top-bar">
                    <div class="page-info" style="text-transform: uppercase">{{$business->vendor->fullname()}} / {{$business->name}}</div>
                    ...
                    <div class="user-profile">
                        <img class="user-image" src="{{$business->avatar()['src']}}" alt="{{$business->avatar()['alt']}}">
                        <div class="info">
                            <div class="user-name">{{$business->name}}</div>
                            <div class="user-info">{{$business->slug()}}</div>
                        </div>
